...
#define HOMING_BUMP_MM      { 5, 5, 2 }    // (linear=mm, rotational=°) Backoff from endstops after first bump - X, Y, Z only
#define HOMING_BUMP_DIVISOR { 2, 2, 4 }    // Re-Bump Speed Divisor (Divides the Homing Feedrate) - X, Y, Z only
